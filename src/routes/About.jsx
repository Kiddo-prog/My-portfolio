    ...
    <Box p={5} mx={{ base: "1em", md: "3em", lg: "4.5em" }} my="3em">
      <Flex>
        <Box maxW={{ base: "100%", md: "50%", lg: "60%" }}>
          ...
          <Box>
            <Box mt="20px" p="10px">
              <Link href='/resume.pdf'  _hover={{ boxShadow: "1px 4px 9px #000" }} p="10px" borderRadius="10px" isExternal download>
                  Resume<ExternalLinkIcon mx='2px' />
              </Link>
            </Box>
            <Box d="flex" direction="row" mt="2em">
              ...
              <a style={iconLink} href="https://www.linkedin.com/in/hussein-mubarak-3b00b11b2/">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
              ...
              <a style={iconLink} href="https://github.com/Kiddo-prog">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
